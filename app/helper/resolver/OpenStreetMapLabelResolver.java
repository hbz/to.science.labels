 ...
 * @author Andres Quast
 */
public class OpenStreetMapLabelResolver extends LabelResolver implements LabelResolverInterface {

    final public static String protocol = "https://";
    final public static String alternateProtocol = "http://";
    final public static String domain = "www.openstreetmap.org";
    ...
    public String getLabelResolverClassName() {
        return OpenStreetMapLabelResolver.class.getCanonicalName();
    }
